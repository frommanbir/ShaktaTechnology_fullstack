...
<a href="/send-resume" className="flex items-center px-6 py-3 bg-indigo-600 text-white rounded-md shadow">Send Your Resume <ArrowRight className="ml-2 w-5 h-5" /></a>
