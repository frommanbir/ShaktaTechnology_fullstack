  ...
  useEffect(() => {
    const fetchService = async () => {
      try {
        ...
        // Set form data from fetched service
        setFormData({
          title: serviceData.title || "",
          description: serviceData.description || "",
          price: serviceData.price || "",
          features: serviceData.features && serviceData.features.length > 0 ? serviceData.features : [""],
          technologies: serviceData.technologies && serviceData.technologies.length > 0 ? serviceData.technologies : [""],
        });
      } catch (err) {
        console.error(err);
    ...
    return (
      <div className="min-h-screen bg-slate-50 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-20 text-slate-600">Loading service...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-600 mt-2">Update service details</p>
          </div>
        </div>
